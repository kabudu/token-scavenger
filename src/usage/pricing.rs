...
pub fn estimate_cost(input_tokens: u32, output_tokens: u32, provider_id: &str) -> f64 {
    match provider_id {
        // Free-tier providers
        "groq" | "google" | "openrouter" | "cloudflare" | "cerebras"
        | "nvidia" | "cohere" | "huggingface" | "zai" | "siliconflow"
        | "github-models" => 0.0,
